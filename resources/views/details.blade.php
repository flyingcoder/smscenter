                ...
                <div class="container">
                    <h2 style="color: black; text-align: left">Information Details</h2>
                            ...
                            <div class="form-group{{ $errors->has('parent') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-5">
                                    <input type="parent" class="form-control" name="parent" value="{{ $children->parent }}">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-5">
                                    <input type="name" class="form-control" name="name" value="{{ $children->name }}">
                            ...
                            <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-5">
                                    <input type="phone_number" class="form-control" name="phone_number" value="{{ $children->phone_number }}">
